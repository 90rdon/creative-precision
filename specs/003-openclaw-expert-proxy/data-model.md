# Data Model: OpenClaw Expert Assessment Proxy

Based on FR-004 and the Key Entities from the spec, the system needs to track active assessment sessions associating a front-end browser with an OpenClaw execution context.
...
| `openClawThreadId` | `string` | The ID of the conversation thread on the OpenClaw backend | Yes | External reference |
