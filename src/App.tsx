        ...
        <div className="app-shell">
            {view !== 'landing' && (
                <header className="assess-header">
                    <span className="assess-logo">Reflect.</span>
                    <div className="assess-nav">
                        <span className="text-xs font-medium tracking-widest uppercase text-stone-400 hidden md:inline">Creative Precision</span>
                        <button className="assess-settings" aria-label="Settings" onClick={() => setIsConfigOpen(true)}>
